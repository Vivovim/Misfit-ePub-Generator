...
if ($answer == "0") {
	...
	push @pages, ($bookcover, $titlepage, $copyright, $toclistp);
	...
	push @pages, ($bookcover, $titlepage, $copyright, $toclistp, $dedication);
	...
	push @pages, ($bookcover, $titlepage, $copyright, $toclistp, $dedication, $disclaimer);
	...
	push @pages, ($bookcover, $titlepage, $copyright, $toclistp, $dedication, $disclaimer, $forward);
	...
	push @pages, ($bookcover, $titlepage, $copyright, $toclistp, $disclaimer);
	...
	push @pages, ($bookcover, $titlepage, $copyright, $toclistp, $forward);
	...
	push @pages, ($bookcover, $titlepage, $copyright, $toclistp, $dedication, $forward);
	...
	push @pages, ($bookcover, $titlepage, $copyright, $toclistp, $disclaimer, $forward);
